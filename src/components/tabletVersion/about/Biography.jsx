    ...
    <>
      ...
      <section className={styles.biographyText}>
        <p>
          ...
          for the past 2 years I've been studying the frontend part and now
      ...
      <section>
        ...
        <span>
              <span className={styles.boldText}>English</span>  —  Pre-intermediate/ Intermediate<br/>
              <span className={styles.boldText}>Polish</span>  — Upper-Intermediate<br/>
              <span className={styles.boldText}>Ukrainian</span>  — Native<br/>
            </span>
      </section>
      <section className={styles.workExperience}>
        <h3 className={styles.blockHeader}>Work experience</h3>
        <span>
              <span className={styles.boldText}>2021 - to present time</span> , Gradual training in web development and
              pet project development.
            </span>
        <br />
        <span>
               <span className={styles.boldText}>2022 October  - to present time</span>  , Integrality, Javascript developer
              (HTML, CSS, JS, jQuery).
            </span>
      </section>
    </>
