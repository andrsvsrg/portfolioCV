  ...
  return (
    <div className={styles.wrapper}>
      <div className={styles.content}>
        ...
        <p>
          I don’t stop gaining knowledge for a day; at the moment I have worked
          with many technologies, libraries, etc.
        </p>
        <p className={styles.lastParagraph}>
          I delved into some of them, some only superficially, here is most of
          what I worked with:
        </p>
